...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, e_Pin|d_Pin|PWMA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : e_Pin d_Pin PWMA_Pin */
  GPIO_InitStruct.Pin = e_Pin|d_Pin|PWMA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : Button1_Pin a_Pin b_Pin */
  GPIO_InitStruct.Pin = Button1_Pin|a_Pin|b_Pin;
